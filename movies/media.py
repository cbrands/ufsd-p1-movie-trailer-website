...
class Movie():
    """This class stores movie related information and can play the trailer in a browser popup"""
    ...
    def __init__(self, movie_title, movie_storyline, poster_image,
        ...
        poster_image: The URL to the image that will be displayed as the movie poster
